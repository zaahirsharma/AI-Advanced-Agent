# Variable assigned prompts are standard prompts that don't change
# Methdod assigned prompts are dynamic and can change based on user input through the method parameters
